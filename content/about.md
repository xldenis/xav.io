...
I'm an engineer at [turbopuffer](https://turbopuffer.com), where I work on the database with a focus on semantic search and peformance. previously

Previously I was a postdoctoral researcher at [ETH Zürich](https://ethz.ch) in the [programming methodology group](https://www.pm.inf.ethz.ch/about-us.html) where I work on the performance and methodology of formal verification.
I did my PhD student at the [LMF](https://lms.cnrs.fr) where I developed [Creusot](https://github.com/creusot-rs/creusot), a state-of-the-art verifier for Rust based on translation to *pure*, *functional* programs.
